...
//  Follows the ProjectView pattern for centered modal display.
//
//-------------------------------------------------------------------------------------------------
class HelpView
{
  public:
    ...
    HelpView( ProgramDefaults *pd, CxScreen *screen );
    // Constructor
    ...
    // mark as first run to show welcome message
  ...
  private:
    ...
    int _isFirstRun;        // show welcome message on first run
