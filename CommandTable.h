...
//
// For commands with CMD_FLAG_SYMBOL_ARG, the symbolFilter field specifies the prefix
// used to filter symbols (e.g., "box-" for utf-box, "sym-" for utf-symbol).
//-------------------------------------------------------------------------------------------------
struct CommandEntry
{
    ...
    const char *symbolFilter;   // symbol filter prefix ("box-", "sym-") or NULL
};
